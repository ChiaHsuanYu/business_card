...
<div class="modal fade" id="confirmModal" tabindex="-1" role="dialog" aria-labelledby="confirm_modal_label" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <input type="hidden" id="confirm_userId">
        <input type="hidden" id="confirm_isDeleted">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="btnBox">
                <button type="button" class="button width_60px" data-dismiss="modal" onclick="update_isDeleted();">確定</button>
